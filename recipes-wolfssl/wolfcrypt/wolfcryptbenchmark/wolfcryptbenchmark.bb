...
python () {
    if d.getVar('UNPACKDIR', False):
        d.setVar('S', '${UNPACKDIR}/${BP}/wolfcrypt/benchmark')
    else:
        d.setVar('S', '${WORKDIR}/git/wolfcrypt/benchmark')
}
DEPENDS += "virtual/wolfssl"

inherit wolfssl-compatibility

# FIXME - Not everything needs to do an RDEPENDS- and really?  This only
#         works right if you've got all the recipes sorted out instead of
#         being a kludge-fest...
#
# python __anonymous() {
